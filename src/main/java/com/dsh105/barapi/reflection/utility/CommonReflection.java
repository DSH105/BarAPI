...
import com.dsh105.barapi.reflection.*;
            ...
            /*if (!MINECARFT_PACKAGE.startsWith(MINECARFT_PACKAGE_PREFIX)) {
                ...
                if (MINECARFT_PACKAGE.equals(FORGE_ENTITY_PACKAGE)) {
                    ...
                    try {
                        ...
                        if (VERSION_TAG == null)
                            BarAPI.getCore().LOGGER_REFLECTION.warning("Version tag is null and it appears the server is modded but does not contain the expected method(s)! HoloAPI may not work correctly!");
                    }
